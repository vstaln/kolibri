...
<head>
  ...
  <style>#lessons{position:relative;overflow:hidden}.lesson-painting{position:absolute;inset:0;z-index:0}#lessons>h2,.lesson-stage{position:relative;z-index:1}</style>
</head>
<body>
  <header class="nav-shell">
    <nav class="nav-bar" aria-label="Primary">
      ...
      <div class="nav-primary">
        <div class="nav-links">
          <a href="https://alignment.id/gray" class="nav-link">GRAY</a>
          <a href="https://alignment.id/#research" class="nav-link">RESEARCH</a>
  ...
  <main>
    ...
    <section class="section moire-section" id="how" aria-labelledby="concepts-title">
      <div class="moire-copy">
      ...
      <div class="moire-visual" id="moire-visual">
        <svg class="moire-svg" viewBox="0 0 720 520" role="img" aria-label="An abstract moiré field whose hidden form appears as two line layers move across one another.">
          <defs>
            <radialGradient id="moire-fade" cx="54%" cy="48%" r="62%">
              <stop offset="0%" stopColor="white" />
              <stop offset="52%" stopColor="white" stopOpacity="0.94" />
              <stop offset="82%" stopColor="white" stopOpacity="0.28" />
              <stop offset="100%" stopColor="black" stopOpacity="0" />
            </radialGradient>
            <mask id="moire-lens">
              <rect width="720" height="520" fill="black" />
              <ellipse cx="410" cy="255" rx="225" ry="172" fill="url(#moire-fade)" />
            </mask>
          </defs>
          <g class="moire-parallax-a"><g class="moire-field" data-field="a"></g></g>
          <g class="moire-parallax-b"><g class="moire-field" data-field="b"></g></g>
          <g mask="url(#moire-lens)" class="moire-lens"><g class="moire-lens-field" data-field="b"></g></g>
        </svg>
      </div>
    </section>
