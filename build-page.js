...
<body>
  ...
  <main>
    ...
    <section class="section section-dark" id="independent" aria-labelledby="independent-title">
      ...
      <div class="guidance-stages" id="guidance-stages">
        <div class="guidance-tabs">
          <button type="button" class="guidance-tab" data-stage="guided" aria-pressed="true">Guided</button>
          <button type="button" class="guidance-tab" data-stage="partial" aria-pressed="false">Partial</button>
          <button type="button" class="guidance-tab" data-stage="open" aria-pressed="false">Open</button>
        </div>
        <div class="guidance-panel" data-panel="guided">
          <ul><li>Relevant file highlighted</li><li>Detailed task</li><li>Visible expected output</li><li>Clear automated check</li></ul>
        </div>
        <div class="guidance-panel" data-panel="partial" hidden>
        ...
        <div class="guidance-panel" data-panel="open" hidden>
